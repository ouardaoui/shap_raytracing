...
/*   Updated: 2023/08/27 19:37:46 by aouardao         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	loop_sphere(t_scene *scene, t_point *data, t_vec3 ray_origin,
		t_vec3 ray_dir)
{
	double		t;
...
void	loop_cylindre(t_scene *scene, t_point *data, t_vec3 ray_origin,
		t_vec3 ray_dir)
{
	double		t;
...
void	loop_plane(t_scene *scene, t_point *data, t_vec3 ray_origin,
		t_vec3 ray_dir)
{
	double	t;
